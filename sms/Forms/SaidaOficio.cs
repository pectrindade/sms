...
{
    public partial class SaidaOficio : Form
    {
        public SaidaOficio()
        {
            InitializeComponent();
        ...
        private void SaidaOficio_Load(object sender, EventArgs e)
        {
        ...
        private void RetornoPesquisa()
        {
            if (Parametros.Valor != "")
            {
                ...
                BuscaPedido(int.Parse(Parametros.Valor));
                CarregaGrid();
        ...
        public void BuscaPedido(int cod)
        {
        ...
        public void BuscaPedido()
        {
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    {
                        MessageBox.Show("Pedido Não Aprovado ", "Aviso Importante",
                        MessageBoxButtons.OK,
                        MessageBoxIcon.Exclamation,
                        MessageBoxDefaultButton.Button1);
        ...
        private void CarregaGrid()
        {
            ...
            var dr = Pedido.SelectOficio(int.Parse(txtCodigo.Text), txtNumeroPedido.Text);
        ...
        {
            ControlaEstoque(int.Parse(Usuario.Codempresa), 322, "", "2");
        }
    }
}
