...
{
    public partial class Autoriza_Oficio : Form
    {

        int loopestubs = 0;

        public Autoriza_Oficio()
        {
            InitializeComponent();
        }

        private void Autoriza_Oficio_Load(object sender, EventArgs e)
        {
            if (Parametros.Valor != "")
            {
        ...
        private void Autoriza_Oficio_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Autoriza_Oficio_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void btnAutoriza_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                ...
                var m = new Pedido();
                m.AprovaOficio(int.Parse(txtCodigo.Text.Trim()));
            }
            if (result == DialogResult.No)
            {
                var m = new Pedido();
                m.RetornaAprovaOficio(int.Parse(txtCodigo.Text.Trim()));
